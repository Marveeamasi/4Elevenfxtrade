...
export default function page() {
  ...
  return (
    ...
    <div
      key={index}
      className={`fixed bottom-${5 + index * 5} z-[111] left-2 p-4 rounded-lg bg-[#081314ce] backdrop-blur-md border border-[#fff1] text-[11px] animate-slide-in animate-duration-1000 w-[250px]`}
    >
