  ...
  return (
    <div className='w-full flex max-sm:flex-col max-sm:justify-center sm:items-start items-center p-4 sm:p-20 gap-4 sm:gap-10 pt-10 bg-[#121516ef]'>
      ...
      <div className='sm:flex-[1] flex flex-col gap-4 max-sm:w-full items-start max-sm:items-center'>
        ...
        <p className='max-sm:text-center'>4Elevenfxtrade is place where traders can access real-world markets with crypto currencies and start trading instantly.
           We offer deposits and withdrawals via cryptos, overcoming the biggest hurdle letting traders instantly transact funds. By using cyrptos instead of fiat, we provide traders instant deposits,
           lightning fast execution, worldwide market access from around the globe, tight spreads and best client support.</p>
