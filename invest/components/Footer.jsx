  ...
  <div className='flex-[1] flex max-sm:flex-col-reverse max-sm:justify-center sm:items-start items-center p-4 sm:px-20 gap-4 sm:gap-10 mt-20'>
    <div className='sm:flex-[1] flex flex-col gap-4 max-sm:w-full items-start max-sm:items-center'>
      ...
      <div className='flex gap-5 items-center'>
        <a href="#" className='text-2xl text-[#a2a1ab] hover:text-[#eee]'><FaFacebookSquare/></a>
      <a href="#" className='text-2xl text-[#a2a1ab] hover:text-[#eee]'><FaSquareXTwitter/></a>
      <a href="#" className='text-2xl text-[#a2a1ab] hover:text-[#eee]'><FaLinkedin/></a>
      <a href="#" className='text-2xl text-[#a2a1ab] hover:text-[#eee]'><FaInstagramSquare/></a>
      <a href="#" className='text-2xl text-[#a2a1ab] hover:text-[#eee]'><BsDiscord/></a>
      </div>
    </div>
  </div>
    </div>
