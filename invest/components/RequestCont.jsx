...
export default function RequestCont() {
    ...
    const requestItems = [
       ...
       {plan:'silver', status:'approved', amount: 4000, date:'12-05-24',},
       {plan:'gold', status:'pending', amount: 333000, date:'12-05-24',},
       {plan:'silver', status:'pending', amount: 33000, date:'11-05-24',},
       {plan:'silver', status:'approved', amount: 32000, date:'10-05-24',},
       {plan:'gold', status:'approved', amount: 90000, date:'09-05-24',},
       {plan:'silver', status:'approved', amount: 25000, date:'08-05-24',},
       {plan:'silver', status:'approved', amount: 45000, date:'08-05-24',},
       {plan:'silver', status:'pending', amount: 13000, date:'08-05-24',},
       {plan:'silver', status:'failed', amount: 32000, date:'08-05-24',},
       {plan:'gold', status:'pending', amount: 244000, date:'08-05-24',},
       {plan:'gold', status:'pending', amount: 300000, date:'08-05-24',},
       {plan:'silver', status:'pending', amount: 40000, date:'08-05-24',},
       {plan:'diamond', status:'pending', amount: 2000, date:'06-05-24',},
       {plan:'silver', status:'pending', amount: 54000, date:'06-05-24',},
       {plan:'silver', status:'pending', amount: 76000, date:'06-05-24',},
       {plan:'silver', status:'pending', amount: 54000, date:'05-05-24',},
       {plan:'generational', status:'approved', amount: 12300000, date:'02-05-24',},
       {plan:'silver', status:'approved', amount: 95000, date:'29-04-24',},
       {plan:'silver', status:'approved', amount: 90000, date:'28-04-24',},
       {plan:'gold', status:'approved', amount: 80000, date:'25-04-24',},
       {plan:'silver', status:'pending', amount: 40000, date:'23-04-24',},
       {plan:'diamond', status:'approved', amount: 2000, date:'23-04-24',},
       {plan:'diamond', status:'approved', amount: 3000, date:'21-04-24',}
    ]
  ...
  return (
    <div className='grid grid-cols-1 w-full mt-10 gap-2'>
        <RequestItems  plan={'silver'} status={'approved'} amount={1233320} date={'09-12-24'}/>
     {slicedData.map((r, i) => (
